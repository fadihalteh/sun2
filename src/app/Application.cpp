...
Application::Application()
    ...
    // Build the full runtime once so main() stays trivial.
...
// Application assembly and top-level event-loop execution.
int Application::run() {
    // Application startup is complete once the Linux event loop takes ownership.
